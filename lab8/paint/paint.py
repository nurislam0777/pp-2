...
rect_img = pygame.image.load("/Users/nurislambekbolat/Desktop/pp2 /lab8/paint/images/rec.png")
rect_img = pygame.transform.scale(rect_img, (50, 50))
but1_rect = rect_img.get_rect(center=(50, 50))
circle_img = pygame.image.load("/Users/nurislambekbolat/Desktop/pp2 /lab8/paint/images/circle.jpeg")
circle_img = pygame.transform.scale(circle_img, (50, 50))
but2_rect = circle_img.get_rect(center=(150, 50))
eraser_img = pygame.image.load("/Users/nurislambekbolat/Desktop/pp2 /lab8/paint/images/eraser.png")
eraser_img = pygame.transform.scale(eraser_img, (50, 50))
but3_rect = eraser_img.get_rect(center=(350, 50))
red_img = pygame.image.load("/Users/nurislambekbolat/Desktop/pp2 /lab8/paint/images/red.png")
red_img = pygame.transform.scale(red_img, (50, 50))
but_r_rect = red_img.get_rect(center=(450, 50))
green_img = pygame.image.load("/Users/nurislambekbolat/Desktop/pp2 /lab8/paint/images/green.png")
green_img = pygame.transform.scale(green_img, (50, 50))
but_g_rect = green_img.get_rect(center=(550, 50))
blue_img = pygame.image.load("/Users/nurislambekbolat/Desktop/pp2 /lab8/paint/images/blue.png")
blue_img = pygame.transform.scale(blue_img, (50, 50))
but_b_rect = blue_img.get_rect(center=(650, 50))
pencil_img = pygame.image.load("/Users/nurislambekbolat/Desktop/pp2 /lab8/paint/images/pencil.png")
pencil_img = pygame.transform.scale(pencil_img, (50, 50))
but_line_rect = pencil_img.get_rect(center=(250, 50))
saver_img = pygame.image.load("/Users/nurislambekbolat/Desktop/pp2 /lab8/paint/images/saver.png")
