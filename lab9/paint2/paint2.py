...
rect_img = pygame.image.load("/Users/nurislambekbolat/Desktop/pp2/Lab9/paint2/images/rec.png")
rect_img = pygame.transform.scale(rect_img, (30, 30))
but1_rect = rect_img.get_rect(center=(40, 30))
circle_img = pygame.image.load("/Users/nurislambekbolat/Desktop/pp2/Lab9/paint2/images/circle.jpeg")
circle_img = pygame.transform.scale(circle_img, (30, 30))
but2_rect = circle_img.get_rect(center=(100, 30))
pencil_img = pygame.image.load("/Users/nurislambekbolat/Desktop/pp2/Lab9/paint2/images/pencil.png")
pencil_img = pygame.transform.scale(pencil_img, (30, 30))
but_line_rect = pencil_img.get_rect(center=(160, 30))
eraser_img = pygame.image.load("/Users/nurislambekbolat/Desktop/pp2/Lab9/paint2/images/eraser.png")
eraser_img = pygame.transform.scale(eraser_img, (30, 30))
but3_rect = eraser_img.get_rect(center=(220, 30))
square_img = pygame.image.load('/Users/nurislambekbolat/Desktop/pp2/Lab9/paint2/images/square.png')
square_img = pygame.transform.scale(square_img, (30, 30))
but4_rect = square_img.get_rect(center=(280, 30))
rtriangle_img = pygame.image.load('/Users/nurislambekbolat/Desktop/pp2/Lab9/paint2/images/righttriangle.png')
rtriangle_img = pygame.transform.scale(rtriangle_img, (30, 30))
but5_rect = rtriangle_img.get_rect(center=(340, 30))
etriangle_img = pygame.image.load('/Users/nurislambekbolat/Desktop/pp2/Lab9/paint2/images/eqtriangle.png')
etriangle_img = pygame.transform.scale(etriangle_img, (30, 30))
but6_rect = etriangle_img.get_rect(center=(400, 30))
rhombus_img = pygame.image.load('/Users/nurislambekbolat/Desktop/pp2/Lab9/paint2/images/rhombus.png')
rhombus_img = pygame.transform.scale(rhombus_img, (30, 30))
but7_rect = rhombus_img.get_rect(center=(460, 30))
red_img = pygame.image.load("/Users/nurislambekbolat/Desktop/pp2/Lab9/paint2/images/red.png")
red_img = pygame.transform.scale(red_img, (30, 30))
but_r_rect = red_img.get_rect(center=(520, 30))
green_img = pygame.image.load("/Users/nurislambekbolat/Desktop/pp2/Lab9/paint2/images/green.png")
green_img = pygame.transform.scale(green_img, (30, 30))
but_g_rect = green_img.get_rect(center=(580, 30))
blue_img = pygame.image.load("/Users/nurislambekbolat/Desktop/pp2/Lab9/paint2/images/blue.png")
blue_img = pygame.transform.scale(blue_img, (30, 30))
but_b_rect = blue_img.get_rect(center=(640, 30))
saver_img = pygame.image.load("/Users/nurislambekbolat/Desktop/pp2/Lab9/paint2/images/saver.png")
